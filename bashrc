...
# battery status
#PS1="[\$(/home/onykage/battery.stat.sh)] \u@\h:\w \$"


# floating clock
# source = tldp.org
function prompt_command {
	# prompt_X is where to position the curser to write the clock
	let prompt_x=$(tput cols)-15
	#move up one;
#	tput cuu1
	tput sc
	tput cup 0 ${prompt_x}
	...
	echo -n "["
	tput setaf 1
	echo -n "$(/home/onykage/battery.stat.sh)"
	tput setaf 4
	echo -n "]"
	tput rc
}
